...
for (const name of ['bridge.mjs','bridge-memory.mjs','client.mjs','worker-loader.js','compile_model.py','results.py','configure-runtime.mjs','README.md','LICENSE']) await copyFile(name, `browser-artifact/${name}`);
